...
// 사운드 매니저 - BGM/효과음 재생 담당 (현재 대부분 주석 처리된 상태, UI 효과음만 활성)
public class SoundManager
{
    string _buttonClickSound = "Click_CommonButton";
    string _popupCloseSound = "PopupClose_Common";
    ...
    {
        Play(Define.Sound.Effect, _buttonClickSound);
    }

    public void PlayPopupClose()
    {
        Play(Define.Sound.Effect, _popupCloseSound);
    }
